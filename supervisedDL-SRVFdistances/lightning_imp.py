...
import os
import math
from data_model_utils import ShapeDataset, MyDataModule, CyclicPad, LayerNorm, DistanceModel 
wandb_logger = WandbLogger(project="Oblika", name="cyclic_pad_model_L1Loss_new_shape_refactored")
...
checkpoint_callback = ModelCheckpoint(
        ...
        filename="new_shape_Salil_MaxPool-{epoch}-{step}-{val_loss:.4f}",
    )
...
dm = MyDataModule(batch_size=BATCH_SIZE,
